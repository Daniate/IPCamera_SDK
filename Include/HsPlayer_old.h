...
#define HSPLAYER_CALBACK  __stdcall
...
#define HI_STREAM_FILE		1
    ...
    typedef HRESULT (HSPLAYER_CALBACK *HI_PLAYER_StateCallBack)(PLAYHANDLE hHandle,
            PLAYER_STATE_ID_E eStateID,
            HI_U32 u32State,
            HI_VOID *pPara);

    typedef HRESULT (HSPLAYER_CALBACK *HI_PLAYER_PostDrawCallBack)(PLAYHANDLE hHandle,
            HI_VOID *hDc,
	...
	typedef HRESULT (HSPLAYER_CALBACK *HI_PLAYER_PostDrawCallBackEx)(PLAYHANDLE hHandle,
			HI_VOID *hDc,
			HI_S32 s32ImageWidth,
			HI_S32 s32ImageHeight,
			HI_S32 s32WndWidth,
    ...
    typedef HRESULT(HSPLAYER_CALBACK *HI_PLAYER_DecCallBack )(PLAYHANDLE hHandle,
            const PLAYER_FRAME_INFO_S *pFrameInfo,
            HI_VOID *pPara);

    typedef HRESULT(HSPLAYER_CALBACK *HI_PLAYER_TalkCallBack)(PLAYHANDLE hHandle,
            HI_U8 *pBuf,
            HI_S32 s32Size,
            HI_U64 u64TimeStamp,
            HI_VOID *pPara);
	...
	HSPLAYER_API HRESULT HSPLAYER_APICALL HI_PLAYER_RefreshImage(PLAYHANDLE hHandle);
