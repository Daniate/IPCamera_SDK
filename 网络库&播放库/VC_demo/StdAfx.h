...
#include "./include/hi_net_dev_errors.h"
#include "./include/hi_voice_api.h"
#include "./include/HsPlayer.h"

#pragma comment(lib, "./lib/NetLib.lib")
#pragma comment(lib, "./lib/HIPlayer.lib")
#pragma comment(lib, "./lib/hisi_voice_engine.lib")
